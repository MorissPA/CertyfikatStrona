    ...
    <footer className="bg-white shadow-inner mt-8 p-6">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="text-left">
          ...
          <p className="text-sm text-gray-700 font-sans font-bold">Firma Rozwoju Personalnego</p>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center">
            ...
            <span className="text-gray-700 text-sm ml-2 font-bold">+48 508 399 556</span>
          </div>
